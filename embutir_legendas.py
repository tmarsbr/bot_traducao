...
Style: Default,Arial,58,&H00FFFFFF,&H000000FF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,3,3,0,2,10,10,30,1
...
def embutir_legendas(video_entrada, srt_traduzido, video_saida):
    ...
    try:
        ...
        if usa_ass:
            ...
            filtro = f"subtitles={temp_legenda.name}:force_style='FontSize=58,Bold=-1,Outline=3,BackColour=&H80000000,BorderStyle=3,MarginV=30'"
